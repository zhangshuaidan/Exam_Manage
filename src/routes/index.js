...
// 个人系统文件路由
import Home from "../components/MySystem/welcome";
// 管理路由
import ClassesManage from "../components/MySystem/manage/ClassesManage";
import CourseManage from '../components/MySystem/manage/CourseManage';
import ElectiveManage from "../components/MySystem/manage/ElectiveManage";
import InvigilatorManage from "../components/MySystem/manage/InvigilatorManage";
import RoomManage from "../components/MySystem/manage/RoomManage";
// 考试安排路由
import ExamArrange from '../components/MySystem/arrage/ExamArrange';
    ...
    render() {
        return (
            <Switch>
                ...
                {/* 个人系统文件路由 */}
                <Route exact path="/app/myweb/home" component={Home} />
                {/* 管理路由 */}
                <Route exact path="/app/manage/classesmanage" component={ClassesManage} />
                <Route exact path="/app/manage/coursemanage" component={CourseManage} />
                <Route exact path="/app/manage/electivemanage" component={ElectiveManage} />
                <Route exact path="/app/manage/invigilatormanage" component={InvigilatorManage} />
                <Route exact path="/app/manage/roommanage" component={RoomManage} />
                {/* 考试安排路由 */}
                <Route exact path="/app/arrange/examarrange" component={ExamArrange} />
